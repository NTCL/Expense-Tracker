    ...
    return (
        <>
            ...
            <div className='home-expense'>
                <div className='home-expense-buttons'>
                    <button className='et-button et-p3'>
                        <Link className="home-expense-summary" to="/summary" state={{
                            expenseTotal,
                            expenseByType,
                            expenseByTypeDisplay
                        }}>
                            Summary
                        </Link>
                    </button>
                    <button className='et-button et-p3' onClick={e => expenseDialogRef.current.show({id: 0})}>Add</button>
                </div>
                <Entry
                    entry={useMemo(() => {
                        return {
